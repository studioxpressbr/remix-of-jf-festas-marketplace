  ...
  return (
    <>
      <section className="relative overflow-hidden bg-gradient-hero py-16 md:py-24 lg:py-32">
        ...
        <div className="absolute right-20 top-32 animate-float text-3xl opacity-15" style={{ animationDelay: '1s' }}>🎈</div>
        <div className="absolute bottom-20 left-1/4 animate-float text-3xl opacity-15" style={{ animationDelay: '2s' }}>🍰</div>
        <div className="absolute bottom-32 right-1/3 animate-float text-4xl opacity-15" style={{ animationDelay: '0.5s' }}>✨</div>
        ...
        <div className="container relative">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <h1 className="animate-fade-in font-display text-3xl font-bold leading-tight text-foreground sm:text-4xl md:text-5xl lg:text-6xl">
              ...
              <span className="text-gradient-orange">fornecedores</span>{' '}
              para sua festa
            </h1>

            {/* Subheading */}
            <p className="mt-6 animate-fade-in text-base text-muted-foreground sm:text-lg md:text-xl" style={{ animationDelay: '0.2s' }}>
              Confeitarias, decorações, salgados e muito mais. 
              Conecte-se diretamente com os melhores profissionais de JF.
            </p>
            ...
            {/* CTAs */}
            {!user && (
              <div className="mt-8 flex animate-fade-in flex-col items-center justify-center gap-4 sm:flex-row" style={{ animationDelay: '0.4s' }}>
                <Button
                  size="lg"
